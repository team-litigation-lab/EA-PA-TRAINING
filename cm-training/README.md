...
| **📞 Calls** | Opens the LSH Training Portal's shared **Call Simulator** (Case Management pack: 27 calls on the John Doe file) and **Calendaring** simulator (see below) |
